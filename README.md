...
void chargerSprites () {
    	 ...
    	 image[80]=load_bitmap("../obstacle_petit_horizontal.png",NULL);
    	 image[81]=load_bitmap("../obstacle_grand_horizontal.png",NULL);
    	 image[82]=load_bitmap("../obstacle_petit_vertical.png",NULL);
    	 image[83]=load_bitmap("../obstacle_grand_vertical.png",NULL);
    	 image[84]=load_bitmap("../bulle_petite_pleine.png",NULL);
    	 image[85]=load_bitmap("../bulle_moyenne_pleine.png",NULL);
    	 image[86]=load_bitmap("../bulle_grande_pleine.png",NULL);
    	 image[87]=load_bitmap("../boss_mouvement_ailes_1.png",NULL);
    	 image[88]=load_bitmap("../boss_mouvement_ailes_2.png",NULL);
    	 image[89]=load_bitmap("../boss_mouvement_ailes_3.png",NULL);
    	 image[90]=load_bitmap("../boss_mouvement_ailes_4.png",NULL);
    	 image[91]=load_bitmap("../boss_mouvement_ailes_5.png",NULL);
    	 image[92]=load_bitmap("../boss_mouvement_ailes_6.png",NULL);
    	 image[93]=load_bitmap("../boss_perd_1.png",NULL);
    	 image[94]=load_bitmap("../boss_perd_2.png",NULL);
    	 image[95]=load_bitmap("../boss_perd_3.png",NULL);
    	 image[96]=load_bitmap("../boss_perd_4.png",NULL);
    	 image[97]=load_bitmap("../boule_de_feu_petite_pleine.png",NULL);
    	 image[98]=load_bitmap("../boule_de_feu_petite_aplatie.png",NULL);
    	 image[99]=load_bitmap("../boule_de_feu_moyenne_pleine.png",NULL);
    	 image[100]=load_bitmap("../boule_de_feu_moyenne_aplatie.png",NULL);
    	 image[101]=load_bitmap("../boule_de_feu_grande_pleine.png",NULL);
    	 image[102]=load_bitmap("../boule_de_feu_grande_aplatie.png",NULL);
}
